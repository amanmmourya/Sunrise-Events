    ...
    return (
        ...
        <div className='flex justify-start items-start bg-[#efdfdf] p-10'>
            <div className='left-contact w-[50vw] space-y-5'>
                ...
                <div className='flex justify-center items-center ml-10 space-x-5'>
                    <div>
            ...
            <div className='right-contact ml-[5vw] w-[40vw] '>
                ...
                Follow us on
                    ...
                    <div className="instagram flex space-y-2">
                        <FaInstagram size={28} className='mx-2 big-text1'/><div className='big-text'>Insta id</div>
                    </div>
                    <div className="facebook flex space-y-2">
                        <FaFacebook size={28} className='mx-2 big-text1'/><div className='big-text'>Facebook id</div>
                    </div>
                    <div className="twitter flex space-y-2">
                        <FaTwitter size={28} className='mx-2 big-text1 '/><div className='big-text'>Twitter id</div>
